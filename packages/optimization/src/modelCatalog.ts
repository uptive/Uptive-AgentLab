import type { ModelId, Usage } from "@agentlab/contracts";
...
// Anthropic first-party list prices (as of 2026-06). Group 1 (agent runtime) should own the
// real model registry; replace this with theirs at integration.
