...
import { theme, useTheme, withAlpha } from "../theme.js";
  ...
  return (
    <EditorContext.Provider value={ctx}>
      <div style={{ display: "flex", flexDirection: "column", height: "100%", minHeight: 0 }}>
        <header style={{ display: "flex", alignItems: "center", gap: 8, padding: "8px 12px", borderBottom: `1px solid ${theme.border}` }}>
        ...
        {notice ? (
          <div
            style={{
              padding: "6px 12px",
              fontSize: 12,
              background: notice.kind === "error" ? withAlpha(DANGER, 13) : withAlpha(theme.primary, 9),
