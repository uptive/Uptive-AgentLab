...
const handleStyle = { width: 12, height: 12, background: theme.primary, border: `2px solid ${theme.pageBg}` };
      ...
      style={{
        ...
        boxShadow:
          demoNode?.state === "running"
            ? `0 0 14px ${withAlpha(DEMO_COLORS.running, 53)}`
            : selected
              ? `0 0 0 3px ${withAlpha(theme.primary, 25)}`
              : theme.cardShadow,
